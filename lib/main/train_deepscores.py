...
def main():
    ...
    learning_rate = rnd(3, 5) # gets a number (log uniformly) on interval 10^(-3) to 10^(-5)
    ...
    regularization_coefficient = rnd(3, 6) # gets a number (log uniformly) on interval 10^(-3) to 10^(-6)
