...
if __name__ == '__main__':
    ...
    parser.add_argument("--prefetch_len", type=int, default=6, help="prefetch queue len")
    ...
    parser.add_argument("--tensorboard_interval", type=int, default=1, help="after how many iterations is tensorboard updated")
    ...
    # energy markers
                            {'ds_factors': [1], 'downsample_marker': True, 'overlap_solution': 'max',
                                 ...
                                 'stamp_args':{'marker_dim': (9,9),'size_percentage': 0.8, "shape": "oval", "loss": "reg", "energy_shape": "linear"}},
    # class markers
